...
// The styx Token Contract
contract styx is ERC20Interface{
    string public name = "styx";
    string public symbol = "styx";
...
contract styxICO is styx{
    address public admin;
    address payable public deposit;
    uint tokenPrice = 0.001 ether;  // 1 ETH = 1000 styx, 1 styx = 0.001
   ...
   receive () payable external{
    ...
    function transfer(address to, uint tokens) public override returns (bool success){
        ...
        super.transfer(to, tokens);  // same styx.transfer(to, tokens);
        return true;
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success){
        ...
        styx.transferFrom(from, to, tokens);  // same as super.transferFrom(to, tokens);
        return true;
